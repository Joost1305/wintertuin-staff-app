...
- **Agenda-export en printen**: "Download mijn week (.ics)" en "Download mijn maand (.ics)" zetten je eigen diensten in een bestand dat je in Google Agenda, Apple Agenda of Outlook kunt importeren. Managers hebben dezelfde twee opties voor het complete teamrooster. "Print: wie werkt vandaag" opent het printvenster van de browser met een nette lijst van wie er vandaag werkt, zodat je die kunt uitprinten of als PDF opslaan (kies in het printvenster "Opslaan als PDF" in plaats van een printer).
- **Sleepbare tijdbalk**: bij het inplannen of bewerken van een dienst verschijnt een verticale tijdbalk (06:00&ndash;23:30, in blokken van 30 minuten), net als in Outlook of Google Agenda. Sleep erin om een periode te selecteren, of typ de tijden gewoon rechts in de velden, beide blijven in sync.
...
- **SOP's, printen en concept-behoud**: boven de SOP-lijst staat een "Printen"-knop die een nette lijst opent in het printvenster van de browser (kies "Opslaan als PDF" als je 'm digitaal wilt bewaren). Daarnaast wordt een SOP die je aan het bewerken bent automatisch bewaard als concept, ook als je naar een ander tabblad schakelt of de pagina onbedoeld ververst; zodra je die SOP weer opent staat je tekst er nog, met een melding "Niet-opgeslagen concept hersteld".
- **Link naar de introductiepagina**: rechts in de navigatiebalk staat "Over de Wintertuin ↗", die de losse introductiepagina (`Wintertuin-Intro.html`) in een nieuw tabblad opent. Zorg dat dat bestand (en de tijdlijn waar het naar linkt) in dezelfde map staat als de rest van de app.

- **Back-up downloaden**: bij SOP's staat "Download back-up (.txt)", een leesbaar tekstbestand met alle categorie&euml;n, teksten en checklists. Bij het rooster staat (voor managers) "Download volledige back-up (.csv)", met echt alle diensten ooit ingepland (niet alleen de zichtbare week/maand), te openen in Excel of Google Sheets. Dit is bedoeld als vangnet: voordat je iets groots aanpast, download je even een back-up, zodat je een eerdere versie altijd kunt terugvinden. Let op: dit is een download, geen automatische herstelfunctie in de app zelf; bij een probleem zou je de gegevens er handmatig op basis van dat bestand weer in moeten zetten.

- **Food &amp; Beverage**: het menu is nu opgedeeld in twee hoofdgroepen, Food en Beverage, met daaronder de vrije subcategorie zoals eerder (bakkerij, lunch, diner, koffie, wijn, etc). Elk item is nu volledig te bewerken, inclusief het vervangen van de foto, niet alleen toe te voegen of te verwijderen.
- **Alles bewerkbaar**: menu-items, links en vaste diensten hebben nu allemaal een "Bewerken"-knop, net als SOP's. Niets hoeft meer verwijderd en opnieuw aangemaakt te worden voor een kleine tekstwijziging.
- **Eén centrale back-up**: in het Team-scherm staat bovenaan "Download alle instellingen (.json)", één bestand met alle SOP's, het volledige menu, alle links, de vaste diensten &eacute;n het complete rooster in één keer. De losse back-ups bij SOP's (.txt) en het rooster (.csv) blijven ook gewoon bestaan voor als je liever een leesbaar of Excel-vriendelijk bestand wilt.
